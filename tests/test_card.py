...
def test_representation():
    assert str(Card('As')) == u'A♠'
    assert repr(Card('As')) == u"Card('A♠')"
    assert repr(Card('Ad')) == u"Card('A♦')"
    assert repr(Card('Kh')) == u"Card('K♥')"
    assert repr(Card('Jc')) == u"Card('J♣')"
...
def test_passing_Card_instance_to__init__():
    ...
    assert id(c1) == id(c2)
    assert repr(c1) == u"Card('A♠')"
    assert repr(c2) == u"Card('A♠')"
